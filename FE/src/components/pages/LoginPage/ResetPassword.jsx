...
function ResetPassword() {
  ...
  const handleVerifyOTP = async (e) => {
    ...
    if (!formData.otp.trim()) {
      return setErrorMsg("Please enter the OTP.");
    }
    ...
    try {
      ...
      setErrorMsg(error.response?.data?.message || "Unable to verify OTP.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleResetPassword = async (e) => {
    ...
    if (formData.newPassword !== formData.confirmPassword) {
      return setErrorMsg("Confirmation password does not match.");
    }
    ...
    <div className="login_page">
      ...
      >
        ...
        {isOtpVerified && (
          ...
          >
            New password must be at least 8 characters long, including lowercase letters, numbers, and special characters.
          </p>
        )}
        {errorMsg && (
