...
function getSolutionPreview(content, wordLimit = 15) {
  ...
  */
    ...
    async function handleSearchInviteMember() {
      if (
        !requireWorkspaceAdminPermission("search and invite workspace members")
      ) {
        return;
      }
      ...
      if (keptExistingFileNames.length > 0) {
        setWorkspaceDocumentStatus(
          `${keptExistingFileNames.length} existing ${
            keptExistingFileNames.length === 1
              ? "document was"
              : "documents were"
            ...
            <div className="workspace_member_table">
              ...
              {visibleWorkspaceMembers.length === 0 ? (
                ...
                visibleWorkspaceMembers.map((member) => {
                  ...
                  const isProfileOptionActive =
                    activeMemberProfileId === profileId;
                ...
                <section className="workspace_topic_solutions">
                  <header>
                    <div>
                      ...
                      <p>
                        Every workspace member can upload a solution for this
                        topic and review submissions from other members.
                      </p>
                    </div>
                    <button
                      type="button"
            ...
            <div className="discussion_content_left">
              {discussionTopics.length === 0 && !isTopicFormOpen ? (
                <section className="discussion_empty_state">
                  ...
                  <p>
                    Start the first topic so members can ask questions, share
                    notes, and exchange study materials.
                  </p>
                  {canManageTopics ? (
                    <button
                      type="button"
            ...
            <section className="workspace_study_stats">
              <article>
                ...
                <section>
                  ...
                  <strong>
                    {formatStudySessionDuration(studySessionSeconds)}
                  </strong>
                  <p>This session</p>
                </section>
              </article>
